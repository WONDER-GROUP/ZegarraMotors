...
return [
    'attributes' => [
        ...
        'customer.f_last_name'  => 'apellido paterno',
        'customer.m_last_name'  => 'apellido materno',
        'customer.cellphone'    => 'teléfono',
        'cellphone'             => 'teléfono',
        'customer.address'      => 'dirección',
        'customer.nit'          => 'nit',
        'product.name'          => 'producto',
        'product.branch'        => 'marca',
        'inventory.stock'       => 'stock',
        'inventory.lot'         => 'lote',
        'inventory.purchase_price'        => 'precio de compra',
        'inventory.sale_price'  => 'precio de venta',
        'inventory.exp_date'    => 'fecha de expiración',
