    ...
    <div @click.away="$wire.set('modal', 0)" class="bg-white rounded shadow-lg w-10/12 md:w-1/3">
        ...
        <div class="p-3">
            <form>
                <label class="relative block border-2 border-gray-200 rounded-lg p-1 my-1" for="password">
                    ...
                    <input wire:model="password" class="w-full p-0 text-sm border-none focus:ring-0" id="password"
                        type="text" placeholder="Ingrese una nueva contrase;a si desea cambiar la actual" />
                    @error('password')
        ...
        <div class="flex justify-end items-center w-100 border-t p-1">
            ...
            <button wire:click="update()"
                class="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded text-white">Guardar</button>
        </div>
    </div>
</div>
