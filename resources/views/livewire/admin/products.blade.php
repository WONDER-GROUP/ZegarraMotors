...
<div x-data="{ selected: true }">
    ...
    <div class="py-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <x-jet-button wire:click="$set('product.addService', true)" @click="$wire.set('name', 'Servicio')">
            Agregar servicio
        </x-jet-button>
                            ...
                            <tr>
                                ...
                                <td class="px-2 w-14">
                                    <div class="flex items-center -space-x-4 hover:space-x-1">
                                        @if (Product::isService($product->presentation->name))
                                            <button wire:click="editService({{ $product->id }})"
    ...
    <x-jet-dialog-modal wire:model="product.addService" mt='mt-24'>
        <x-slot name="title">
            Agregar servicio
        </x-slot>
        ...
        <x-slot name="content">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    <x-jet-label for="service" value="Servicio" />
                    <x-jet-input wire:model="product.name" id="name" class="block w-full mt-1" type="text"
                        name="product" placeholder="Ej. Cambio de aceite de motor" required autofocus />
                </div>

                <div>
                    <x-jet-label for="presentation" value="Presentación" />
                    <x-jet-input id="presentation" class="block w-full mt-1" type="text" value="Servicio"
                        name="presentation" disabled autofocus />
                </div>
                ...
                <div>
                    ...
                    <x-jet-input wire:model="product.price" id="price" class="block w-full mt-1" type="number"
                        min="1" max="10000" name="price" placeholder="52" required autofocus />
                </div>
            </div>
        </x-slot>
    ...
    {{-- modal for service --}}
    <x-jet-dialog-modal wire:model="product.editService" mt='mt-24'>
        <x-slot name="title">
            Editar servicio
        </x-slot>
        ...
        <x-slot name="footer">
            ...
            <x-jet-button wire:click="updateService('{{ $productId }}')" wire:loading.attr="disabled">
                Actualizar
            </x-jet-button>
        </x-slot>
    </x-jet-dialog-modal>
